...
# Download the minified or non-minified JavaScript
# In Flowdock, click the scripts menu, and select "New Userscript" (It will not work if you try to place it in the userscripts folder manually)
# Paste the JS from the file you downloaded into the Userscript, and save it
# Quit and restart Flowdock
# In the scripts menu select the new Userscript you created
# Quit and restart Flowdock again
# Your flow should then load with that userscript... if it doesn't try doing a manual refresh of the page.

!http://dl.dropbox.com/u/138203/Screenshots/dy.png!
